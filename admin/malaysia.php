            ...
            <div class="col-lg-12">
                <div class="card">
                    <div class="card-header">
                        ...
                        <button type="button" data-toggle="modal" data-target="#modal-animation-3" class="btn btn-primary btn-sm waves-effect waves-light pull-right">Add New Data</button>
                    </div>
                    <div class="card-body">
                        <?php if (!empty($data)){ ?>
                        <div class="table-responsive">
                            <table id="default-datatable" class="table table-bordered">
                                ...
                                <?php foreach ($data as $eachData) { ?>
                                    <tr>
                                        <td><?php echo $eachData['ori']; ?></td>
                                        <td><?php echo $eachData['mobile']; ?></td>
                                        <td><?php echo $eachData['trip_type']; ?></td>
                                        <td><?php echo $eachData['class']; ?></td>
                                        <td><?php echo $eachData['points']; ?></td>
